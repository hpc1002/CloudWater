...
public class ShoppingCartAdapter extends BaseAdapter {
    ...
    private List<ShopCartListBean.Result.DataList> shoppingCartBeanList;
    ...
    public void setShoppingCartBeanList(List<ShopCartListBean.Result.DataList> shoppingCartBeanList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ShopCartListBean.Result.DataList shoppingCartBean = shoppingCartBeanList.get(position);
        ...
        String attribute = shoppingCartBean.strStandard;
